...
PAYLOAD_PATCHES: dict[str, dict[str, Any]] = {
    ...
    "RobotPosition": {"x": 12.5, "y": 4.75, "z": 0.25, "yaw": 135.0, "robot_id": 7},
    "Buff": {
        "robot_id": 1,
        "buff_type": 3,
        "buff_level": 2,
    ...
    "RuneStatusSync": {"rune_status": 1, "activated_arms": 4, "average_rings": 8.6},
