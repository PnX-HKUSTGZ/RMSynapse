...
#   fields: maximum_difficulty_level,basic_state,status,putin_state,move_state,rotate_state,
#           enemy_core_status,remain_time_all,remain_time_step,last_update_msec
