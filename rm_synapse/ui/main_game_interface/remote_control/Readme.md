...
9. set_sensitivity 设置鼠标灵敏度(最小位 0.01)
10. set_invert_y 设置鼠标 Y 轴反转
11. set_binding 自定义按键绑定
12. reset_bindings 重置为默认按键绑定
13. bindings_preview 返回绑定关系预览字符串
14. action_for_bit 根据位索引返回对应的按键名
15. 剩余均为初始化或工具函数